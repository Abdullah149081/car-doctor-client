    ...
    <div className="my-20 lg:my-32">
      <div className="flex flex-col lg:flex-row lg:gap-x-14">
        <div className="lg:w-1/2 relative">
          <img src={person} className=" rounded-lg 2xl:w-[630px] lg:w-[460px] lg:h-[473px] object-cover" />
        ...
        <div className="lg:w-1/2 space-y-6 mt-6 lg:mt-0">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold tracking-wide lg:leading-[4rem]">We are qualified & of experience in this field</h1>
